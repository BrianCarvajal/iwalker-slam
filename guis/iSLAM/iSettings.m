classdef iSettings < handle
    ...
    methods
        ...
        function default(this)
            ...
            s.FeatureExtractor_ClusterSplitDist = 0.30;
            s.FeatureExtractor_LineSplitDist = 0.15;
            s.FeatureExtractor_MaxOutliers = 3;
            ...
            s.RadarPlot_drawOutRange = true;
            s.RadarPlot_drawDeadAngle = false;
            s.RadarPlot_drawOutlier = false;
        ...
        function show(this)
            ...
            try
                ...
                iconpath = [parentpath(parentpath(mfilename('fullpath'))) filesep 'icons' filesep 'tools.png'];
...
%             end
            ...
            properties = [ ...
                ...
                'Type', PropertyType('denserealdouble', 'scalar', [-360 360]), ...
                'Category', 'Lidar', ...
                'DisplayName', 'theta', ...
                'Description', '...', ...
                'ReadOnly', false) ...
                ...
                'Description', '...') ...
                PropertyGridField('FeatureExtractor_ClusterSplitDist', s.FeatureExtractor_ClusterSplitDist, ...
                'Type', PropertyType('denserealdouble', 'scalar', [0.05 Inf]), ...
                'Category', 'Landmark Extraction', ...
                'DisplayName', 'Cluster Split Distance', ...
                'Description', '...') ...
                PropertyGridField('FeatureExtractor_LineSplitDist', s.FeatureExtractor_LineSplitDist, ...
                'Type', PropertyType('denserealdouble', 'scalar', [0.05 Inf]), ...
                'Category', 'Landmark Extraction', ...
                'DisplayName', 'Line Split Distance', ...
                'Description', '...') ...
                PropertyGridField('FeatureExtractor_MaxOutliers', int32(s.FeatureExtractor_MaxOutliers), ...
                'Type', PropertyType('int32', 'scalar', [1 Inf]), ...
                'Category', 'Landmark Extraction', ...
                'DisplayName', 'Max Outliers', ...
                'Description', '...') ...
                PropertyGridField('Plots_fps', s.Plots_fps, ...
                'Type', PropertyType('denserealdouble', 'scalar', [0.01 10]), ...
                'Category', 'Plot', ...
                'DisplayName', 'fps', ...
                'Description', '...') ...
                ...
                'Description', '...') ...
                PropertyGridField('RadarPlot_drawOutRange', s.RadarPlot_drawOutRange, ...
                'Category', 'Radar Plot', ...
                'DisplayName', 'Draw out range data', ...
                'Description', '...') ...
                PropertyGridField('RadarPlot_drawOutlier', s.RadarPlot_drawOutlier, ...
                'Category', 'Radar Plot', ...
                'DisplayName', 'Draw outliers', ...
                'Description', '...') ...
                PropertyGridField('RadarPlot_drawDeadAngle', s.RadarPlot_drawDeadAngle, ...
                'Category', 'Radar Plot', ...
                'DisplayName', 'Draw data in dead angle', ...
                'Description', '...') ...
