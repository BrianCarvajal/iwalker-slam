classdef iSettings < handle
    ...
    methods
        ...
        function default(this)
            ...
            s.Simulink_model = 'iWalkerRoboPeakModel';
            s.Simulink_COM = '-';
            s.Simulink_SampleTimeOdometry = 0.1;
            s.Simulink_SampleTimeLidar = 0.5;
            s.Simulink_EnableReactiveControl = true;
            s.Simulink_LeftLambda = 0;
            s.Simulink_RightLambda = 0;
            s.Simulink_LeftNu = 0;
            s.Simulink_RightNu = 0;
            s.Simulink_SavePath = cd;
            s.Simulink_count = 0;
        ...
        function show(this)
            ...
            properties = [ ...
                ...
                'Description', '...') ...
                PropertyGridField('Simulink_model', s.Simulink_model, ...
                'Type', PropertyType('char', 'row',  {'iWalkerRoboPeakModel' 'iWalkerHokuyoModel'} ), ...
                'Category', 'Simulink', ...
                'DisplayName', 'Model', ...
                'Description', '...') ...
                PropertyGridField('Simulink_COM', ports{1}, ...
                'Type', PropertyType('char', 'row',  ports), ...
                'Category', 'Simulink', ...
                'DisplayName', 'COM', ...
                'Description', '...') ...
                PropertyGridField('Simulink_SampleTimeOdometry', s.Simulink_SampleTimeOdometry, ...
                'Type', PropertyType('denserealdouble', 'scalar', [0.01 Inf]), ...
                'Category', 'Simulink', ...
                'DisplayName', 'CAN Sample Time', ...
                'Description', '...') ...
                PropertyGridField('Simulink_SampleTimeLidar', s.Simulink_SampleTimeLidar, ...
                'Type', PropertyType('denserealdouble', 'scalar', [0.01 Inf]), ...
                'Category', 'Simulink', ...
                'DisplayName', 'Lidar Sample Time', ...
                'Description', '...') ...
                PropertyGridField('Simulink_EnableReactiveControl', s.Simulink_EnableReactiveControl, ...
                'Category', 'Simulink', ...
                'DisplayName', 'Enable Reactive Control', ...
                'Description', '...') ...
                PropertyGridField('Simulink_LeftLambda', int32(s.Simulink_LeftLambda), ...
                'Type', PropertyType('int32', 'scalar', [0 100]), ...
                'Category', 'Simulink', ...
                'DisplayName', 'Left Lambda', ...
                'Description', '...') ...
                PropertyGridField('Simulink_RightLambda', int32(s.Simulink_RightLambda), ...
                'Type', PropertyType('int32', 'scalar', [0 100]), ...
                'Category', 'Simulink', ...
                'DisplayName', 'Right Lambda', ...
                'Description', '...') ...
                PropertyGridField('Simulink_LeftNu', int32(s.Simulink_LeftNu), ...
                'Type', PropertyType('int32', 'scalar', [0 100]), ...
                'Category', 'Simulink', ...
                'DisplayName', 'Left Nu', ...
                'Description', '...') ...
                PropertyGridField('Simulink_RightNu', int32(s.Simulink_RightNu), ...
                'Type', PropertyType('int32', 'scalar', [0 100]), ...
                'Category', 'Simulink', ...
                'DisplayName', 'Right Nu', ...
                'Description', '...') ...
                PropertyGridField('Simulink_count', s.Simulink_count, ...
                'Category', 'Simulink', ...
                'DisplayName', 'Captures', ...
                'Description', '...', ...
                'ReadOnly', true) ...
                PropertyGridField('Simulink_SavePath', s.Simulink_SavePath, ...
                'Category', 'Log', ...
